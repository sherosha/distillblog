...
The take-away from this investigation is that the smaller schools are heavily concentrated with students who have religious exemptions for the two main childhood vaccines, DTP and MMR. If these schools are outliers compared to the larger schools, how can we explain the extremely low exemption rates in large school.
The low coverage schools are not advertised as dedicated for individuals with exemptions for vaccines so there are many questions that can be asked:
<br>
